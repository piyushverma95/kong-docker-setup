...
build = {
  ...
  modules = {
    ...
    ["kong.plugins.fortress-http-log.handler"] = "kong/plugins/fortress-http-log/handler.lua",
    ["kong.plugins.fortress-http-log.schema"] = "kong/plugins/fortress-http-log/schema.lua",
    ["kong.plugins.fortress-http-log.serializer"] = "kong/plugins/fortress-http-log/serializer.lua",
